			...
			<form name="frm" method="post" action="insert" enctype="multipart/form-data"> 
				<div class="customer_register">
					...
					<div class="info">
						<dl>
							<dt>이름</dt>
							<dd><input type="text" name="name" maxlength="50" placeholder="이름입력" class="reg" /></dd>
						</dl>
					</div>
					<div class="info">
						<dl>
							<dt>주소</dt>
							<dd><input type="text" name="address" maxlength="50" placeholder="주소입력" class="reg" /></dd>
						</dl>
					</div>
					<div class="info">
						<dl>
							<dt>전화번호</dt>
							<dd><input type="text" name="phone" maxlength="50" placeholder="'-'를 포함하여 입력" class="reg" /></dd>
						</dl>
					</div>
					<div class="info">
						<dt>성별</dt>
					...
					<div class="info">
						<dt>나이</dt>
						<dd><input type="number" name="age" maxlength="10" placeholder="나이입력" class="reg" /></dd>
					</div>
					<div class="info">
						<dt>포인트</dt>
						<dd><input type="number" name="point" maxlength="10" placeholder="포인트입력" class="reg" /></dd>
					</div>
					<div class="info">
						<dt>등급</dt>
						<dd>
